...
import agent, { MASK_ADDRESS, TARGET_ACCOUNT, MIN_BALANCE } from "./agent";
...
describe("minimum balance agent", () => {
  ...
  describe("handleBlock", () => {
    it("returns empty findings if balance is above threshold", async () => {
      mockEthersProvider.getBalance.mockReturnValueOnce("5000000000000000001");
    ...
    it("returns a finding if balance is below threshold", async () => {
      const balance = "4000000000000000000";
